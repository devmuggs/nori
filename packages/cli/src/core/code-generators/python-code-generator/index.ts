...
/**
 * Generates a Python module from a NoriYaml definition.
 *
 * The output is a self-contained `.py` file that exposes typed, frozen
 * i18n collection objects using dataclasses and `StrEnum`.
 *
 * Example output:
 *
 * ```python
 ...
 *     _meta_kind: str = "noriI18nCollection"
 *
 ...
 *         """Displayed on first step of onboarding wizard."""
 *         return _col(
